...
Insertion sort is more efficient than selection and bubble sort
because the number of comparisons and shifts in insertion sort
is less on average than in selection or bubble sort.
@author: M
'''
